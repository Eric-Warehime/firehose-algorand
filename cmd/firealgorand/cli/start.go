...
var StartCmd = &cobra.Command{Use: "start", Short: "Starts `firealgorand` services all at once", RunE: firehoseCmdStartE, Args: cobra.ArbitraryArgs}
...
func firehoseCmdStartE(cmd *cobra.Command, args []string) (err error) {
	...
	rootLog.Debug("firealgorand binary started", zap.String("data_dir", dataDir))
