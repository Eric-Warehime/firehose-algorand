...
function main() {
  ...
  generate "sf/algorand/type/v1/type.proto"
  ...
  echo "Eric-Warehime/firehose-algorand/proto revision: `GIT_DIR=$ROOT/.git git log -n 1 --pretty=format:%h -- proto`" >> ./last_generate.txt
}
